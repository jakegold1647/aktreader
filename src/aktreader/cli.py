...
def build_parser() -> argparse.ArgumentParser:
    ...
    collection_inspect = subparsers.add_parser("collection-inspect", help="inspect a local collection")
    collection_inspect.add_argument("collection", type=Path)
    collection_search = subparsers.add_parser("collection-search", help="search a local collection")
