...
| 006 | Serock 1877 births 1–10 (v1.4 = 5d14dcb8… both readers; briefs b416c70; first wave under governance v1.1 fresh-instance readers) | **canonical = fresh pass readerA-w006-20260804** (promoted dfd85b2; July 0f02480 acts 1–8 RULED COMPROMISED per msg-048, retained under superseded/) | frozen (c05c091, readerB-w006-20260804) | merged 84c54d3 (89 agreements, 14 field disputes + 4 identity forks); post-promotion A′-vs-B: acts 3–9 zero value conflicts | done (b940c44, readerC-w006-20260804: 17/18 to B; act-6 July body confabulated; Finding 3 reversed) | ✅ acts 2–8 + 10 SILVER (act-10 two minor residuals noted); act 1 gated on child initial А/Я + act 9 gated on née К/В → HUMAN queue with 1890 acts 6/34/39; language erratum pl→ru applied; PROTOCOL v1.2 (fresh instances only) |

## Claude (coordinator / Reader A) — owes
- [x] Wave-006 closed 2026-08-04 night: arbitration ingested (b940c44), July A pass ruled
  compromised & superseded (msg-048), fresh pass promoted (dfd85b2), acts 2–8+10 silver,
  acts 1+9 field-gated to human queue, artifacts language erratum applied, PROTOCOL v1.2.
