...
| 006 | Serock 1877 births 1–10 (v1.4 = 5d14dcb8… both readers; briefs b416c70; first wave under governance v1.1 fresh-instance readers) | frozen (0f02480 acts 1–8 July + f7391fc acts 9–10 fresh; A′ supplementary retained) | frozen (c05c091, readerB-w006-20260804) | merged (~89 agreements; 14 field disputes + 4 identity-level forks: act 6 whole-act fork w/ suspected region-assignment error, acts 2, 7, 1) | pending (fresh instance) | ⚠ BRIEF ERRATUM: language pin "pl" wrong — ink is ru, BOTH readers independently overrode metadata from the page (guard passed its first production test); B occupation-gloss finding (extends wave-005 validator rec); Fiszman/Fiszbin single letterform spanning 5 acts; acts 3+9+10 one arbitration from silver; human queue: act-6 region fix, act-1 initial А/Я/Ха + née fork, acts 4/5 joint review, act-9 née К/В |
