...
the stored source PAGE XML untouched. Reading-order and region-geometry editing are separate
follow-on work; this first layout path corrects individual line polygons and baselines.
